...
public class Product {
	public String name,description,category,sellerID;
	public int productID;
	public ArrayList<ArrayList<String>> bidderList=new ArrayList<ArrayList<String>>();
	boolean status;
	 public int startBid,lastBid;
